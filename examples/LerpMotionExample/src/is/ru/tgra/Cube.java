...
public class Cube {
	...
	public Cube(String textureImage)
	{
		...
		this.endPosition = new Point3D(5f, 5f, 5f);
	...
	public void update(float time) {
		if(time >= this.startTime && time <= this.endTime){
			float t = (time -this.startTime) / (this.endTime - this.startTime);			
			// update the position of the box.
			this.position = Point3D.lerp(this.startPosition, this.endPosition, t);
			System.out.println("new position: " + this.position.x + "," + this.position.y + "," + this.position.z);
